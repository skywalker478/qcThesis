...
\begin{enumerate}
    \item \textbf{Creating Entangled Pairs:} Either Alice or Bob or any other third party, Charlie, can initiate the process by generating pairs of strongly entangled quantum particles (Bell states). These states ensure that the measurements on the particles are perfectly correlated. There are four Bell states, which are below:
          ...
          For notions such as $\ket{01}$ and \textcolor{cyan}{$\ket{11}$}, the first digit in \textcolor{cyan}{the ket notation} refers to the first qubit, and the second digit refers to the second qubit.
...
In the course of our research, we utilized an amalgam of powerful tools and libraries in the pursuit of the effective implementation of our proposed scheme. The Qiskit SDK from IBM \cite{Wille2019IBMsQT} acted as one of the foundational columns of our research by enabling us to develop and simulate quantum circuits and thus properly implement the E91 protocol. For our implementation, we specifically used Qiskit v0.39.2. Using Qiskit, we developed the singlet circuit for entangled pair generation \ref{fig:singlet}, the measurement circuits of Alice and Bob and the creation of the Final Ekert Key. The respective measurement circuits are shown in Figures \ref{fig:aliceMeasurements} and \ref{fig:bobMeasurements}. \textcolor{cyan}{And we shared the entangled singlet pairs between Alice and Bob in the simulator over an ideal channel; we did not include any photon-loss or channel-noise models in these simulated experiments.}
\begin{figure}[pos=h]
...
\end{equation}
Here, $H(x)$ is the entropy of the signal while $P(x_i)$ is the probability of the $i$th value of signal $x$. For a good encryption technique, it is desirable to have the entropy of the encrypted signal to be as close to $16$ \textcolor{cyan}{bits per sample (bps)} as possible (for 16-bit audio signals). Table \ref{table:entropy} shows the entropy values of the two encrypted signals, as well as those of the embedded signals.
\begin{table}[pos=h]
    \begin{center}
        \caption{Entropy of original embedded audios before encryption, after encryption and after decryption in \textcolor{cyan}{bits per sample (bps)}.}
        \begin{tabular}{ccrc}
            \hline
            \multicolumn{1}{c|}{Audio File} & Original                                  & \multicolumn{1}{c}{Encrypted}                                      & Decrypted                                 \\ \hline
            \multicolumn{1}{c|}{Audio 1}    & $9.708523634053172$ \textcolor{cyan}{bps} & $15.998421037422506$ \textcolor{cyan}{bps}                         & $9.708523634053172$ \textcolor{cyan}{bps} \\
            \multicolumn{1}{c|}{Audio 2}    & $9.792556077074044$ \textcolor{cyan}{bps} & $15.998420782458867$ \textcolor{cyan}{bps}                         & $9.792556077074044$ \textcolor{cyan}{bps} \\ \hline
                                            &                                           & \textit{avg.:}$\mathbf{~15.998420909940687}$ \textcolor{cyan}{bps} &
        \end{tabular}
        \label{table:entropy}
    \end{center}
\end{table}
...
\begin{equation}
    \textcolor{cyan}{\text{NSCR}=\left(\frac{D}{N}\right)\times100\%}
\end{equation}
...
\begin{table}[pos=h]
    \begin{center}
        ...
        \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}X>
            ...
            \toprule
            \textbf{Scheme}                 & \textbf{\textcolor{cyan}{Encryption Scheme}}                                                                        & \textbf{Entropy \textcolor{cyan}{(bps)}} & \textbf{Correlation}  & \textbf{UACI}          & \textbf{NSCR}          \\
            \midrule
            Ref. \cite{farsana2023audio}    & \textcolor{cyan}{Discrete Modified Henon Map + Modified Lorenz Hyperchaotic system}                                 & $N/A$                                    & $0.00971000$          & $33.300000\%$          & $99.999500\%$          \\ \hline
            Ref. \cite{shah2021efficient}   & \textcolor{cyan}{Lossless Binary Gallos Field Extension-Based Algorithm}                                            & $15.369518$                              & $-0.00260000$         & $33.205726\%$          & $99.991687\%$          \\ \hline
            Ref. \cite{abdelfatah2020audio} & \textcolor{cyan}{Self-Adaptive Scrambling + Multi-chaotic Maps + Dynamic DNA Encoding + Cipher Feedback Encryption} & $N/A$                                    & $0.00005300$          & $35.548300\%$          & $99.994800\%$          \\ \hline
            Ref. \cite{lima2016audio}       & \textcolor{cyan}{Cosine Number Transform (CNT)}                                                                     & $15.972500$                              & $N/A$                 & $33.319200\%$          & $99.999213\%$          \\ \hline
            Ref. \cite{naskar2021audio}     & \textcolor{cyan}{Cyclic Shift + PWLCM with Elementary Cellular Automata (ECA)}                                      & $N/A$                                    & $0.00029518$          & $33.559993\%$          & $99.999509\%$          \\ \hline
            Ref. \cite{adeel2020novel}      & \textcolor{cyan}{PWLCM + Chebyshev Map + Secure Hash + S-Box (8-bit audio)}                                         & $7.998300$                               & $0.00022000$          & $33.390000\%$          & $99.950000\%$          \\ \hline
            Ref. \cite{aziz2021noise}       & \textcolor{cyan}{Mordell Elliptic Curves + Permutation + Chaotic Map + S-Box (8-bit audio)}                         & $7.943833$                               & $-0.00667000$         & $25.585000\%$          & $99.583467\%$          \\ \hline
            Ref. \cite{dai2021audio}        & \textcolor{cyan}{Chen Memristor Chaotic System}                                                                     & $N/A$                                    & $0.00095000$          & $32.824200\%$          & $99.920275\%$          \\ \hline
            \textbf{This work}              & \textbf{\textcolor{cyan}{E91 + SHA-3 + Chacha20-Poly1305 + LSB Steganography}}                                      & $\mathbf{15.998420}$                     & $\mathbf{0.00001463}$ & $\mathbf{49.997671\%}$ & $\mathbf{99.998490\%}$ \\
            \bottomrule
        \end{tabularx}
