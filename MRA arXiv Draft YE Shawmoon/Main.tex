...
\begin{figure}[!h]
    \centering
    \includesvg[width=0.5\textwidth]{ChaCha_Cipher_Quarter_Round_Function.svg}
    \caption{The ChaCha quarter-round function. By Tony Arcieri - Own work, CC BY-SA 4.0, \url{https://commons.wikimedia.org/w/index.php?curid=90771650}}
\end{figure}
