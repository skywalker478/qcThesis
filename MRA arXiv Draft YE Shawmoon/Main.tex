...
%\date{} 					% Or removing it
\author[1,3]{\large Md. Raisul Islam Rifat}
\author[2,3]{\large Md. Mizanur Rahman}
\author[1,3]{\large Md. Abdul Kader Nayon}
\author[4]{\large Md Shawmoon Azad}
\author[4, *]{\large M.R.C. Mahdy}
...
\affil[3]{Mahdy Research Academy, Dhaka, Bangladesh}
\affil[4]{Department of Electrical and Computer Engineering, North South University, Dhaka}
...
\nonumfootnote{* Corresponding author.
    \textit{E-mail address}: \href{mailto:mahdy.chowdhury@northsouth.edu}{mahdy.chowdhury@northsouth.edu} (M.R.C. Mahdy).}
